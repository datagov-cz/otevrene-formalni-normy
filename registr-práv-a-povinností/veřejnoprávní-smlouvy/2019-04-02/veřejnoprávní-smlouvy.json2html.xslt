...
<html lang="cs">
  <head>
    ...
    <script class="remove" src="veřejnoprávní-smlouvy.config.js" />
  </head>
  <body>
    <xsl:apply-templates mode="abstrakt" />
    <xsl:sequence select="gen:generujDokumentaciPrvků('../registr-práv-a-povinností/veřejnoprávní-smlouvy/draft/veřejnoprávní-smlouvy.schema.json', '../registr-práv-a-povinností/veřejnoprávní-smlouvy/draft/veřejnoprávní-smlouvy.context.jsonld')"/>
