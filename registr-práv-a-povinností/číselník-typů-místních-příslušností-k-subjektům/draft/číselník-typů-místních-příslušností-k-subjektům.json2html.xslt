...
<html lang="cs">
  <head>
    <title>Registr práv a povinností - číselník typů místních příslušností k subjektům</title>
    ...
    <script class="remove" src="číselník-typů-místních-příslušností-k-subjektům.config.js" />
  </head>
  <body>
    <xsl:apply-templates mode="abstrakt" />
    <xsl:sequence select="gen:generujDokumentaciPrvků('../registr-práv-a-povinností/číselník-typů-místních-příslušností-k-subjektům/draft/číselník-typů-místních-příslušností-k-subjektům.schema.json', '../registr-práv-a-povinností/číselník-typů-místních-příslušností-k-subjektům/draft/číselník-typů-místních-příslušností-k-subjektům.context.jsonld')"/>
