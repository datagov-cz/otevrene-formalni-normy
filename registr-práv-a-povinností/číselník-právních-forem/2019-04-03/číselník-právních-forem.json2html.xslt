...
<html lang="cs">
  <head>
    <title>Registr práv a povinností - číselník právních forem</title>
    ...
    <script class="remove" src="číselník-právních-forem.config.js" />
  </head>
  <body>
    <xsl:apply-templates mode="abstrakt" />
    <xsl:sequence select="gen:generujDokumentaciPrvků('../registr-práv-a-povinností/číselník-právních-forem/draft/číselník-právních-forem.schema.json', '../registr-práv-a-povinností/číselník-právních-forem/draft/číselník-právních-forem.context.jsonld')"/>
