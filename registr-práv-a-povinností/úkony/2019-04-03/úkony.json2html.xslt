...
<html lang="cs">
  ...
  <body>
    ...
    <xsl:sequence select="gen:generujDokumentaciPrvků('../registr-práv-a-povinností/úkony/draft/úkony.schema.json', '../registr-práv-a-povinností/úkony/draft/úkony.context.jsonld')"/>
