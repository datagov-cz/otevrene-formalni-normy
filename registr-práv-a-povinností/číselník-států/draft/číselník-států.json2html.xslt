...
<html lang="cs">
  <head>
    <title>Registr práv a povinností - číselník států</title>
    ...
    <script class="remove" src="číselník-států.config.js" />
  </head>
  <body>
    <xsl:apply-templates mode="abstrakt" />
    <xsl:sequence select="gen:generujDokumentaciPrvků('../registr-práv-a-povinností/číselník-států/draft/číselník-států.schema.json', '../registr-práv-a-povinností/číselník-států/draft/číselník-států.context.jsonld')"/>
