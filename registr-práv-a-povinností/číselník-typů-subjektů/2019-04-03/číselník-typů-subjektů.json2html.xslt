...
<html lang="cs">
  <head>
    ...
    <script class="remove" src="číselník-typů-subjektů.config.js" />
  </head>
  <body>
    <xsl:apply-templates mode="abstrakt" />
    <xsl:sequence select="gen:generujDokumentaciPrvků('../registr-práv-a-povinností/číselník-typů-subjektů/draft/číselník-typů-subjektů.schema.json', '../registr-práv-a-povinností/číselník-typů-subjektů/draft/číselník-typů-subjektů.context.jsonld')"/>
