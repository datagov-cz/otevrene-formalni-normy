...
<html lang="cs">
  ...
  <body>
    ...
    <xsl:sequence select="gen:generujDokumentaciPrvků('../registr-práv-a-povinností/agendové-informační-systémy/draft/agendové-informační-systémy.schema.json', '../registr-práv-a-povinností/agendové-informační-systémy/draft/agendové-informační-systémy.context.jsonld')"/>
