...
<html lang="cs">
  <head>
    <title>Registr práv a povinností - číselník typů činností</title>
    ...
    <script class="remove" src="číselník-typů-činností.config.js" />
  </head>
  <body>
    <xsl:apply-templates mode="abstrakt" />
    <xsl:sequence select="gen:generujDokumentaciPrvků('../registr-práv-a-povinností/číselník-typů-činností/draft/číselník-typů-činností.schema.json', '../registr-práv-a-povinností/číselník-typů-činností/draft/číselník-typů-činností.context.jsonld')"/>
