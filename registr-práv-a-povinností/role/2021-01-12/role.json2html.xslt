...
<html lang="cs">
  ...
  <body>
    ...
    <xsl:sequence select="gen:generujDokumentaciPrvků('../registr-práv-a-povinností/role/2021-01-12/role.schema.json', '../registr-práv-a-povinností/role/2021-01-12/role.context.jsonld')"/>
