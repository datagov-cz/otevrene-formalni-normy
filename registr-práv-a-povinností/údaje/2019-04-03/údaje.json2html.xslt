...
<html lang="cs">
  ...
  <body>
    ...
    <xsl:sequence select="gen:generujDokumentaciPrvků('../registr-práv-a-povinností/údaje/draft/údaje.schema.json', '../registr-práv-a-povinností/údaje/draft/údaje.context.jsonld')"/>
