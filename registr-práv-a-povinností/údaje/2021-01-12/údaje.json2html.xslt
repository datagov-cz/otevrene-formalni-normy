...
<html lang="cs">
  ...
  <body>
    ...
    <xsl:sequence select="gen:generujDokumentaciPrvků('../registr-práv-a-povinností/údaje/2021-01-12/údaje.schema.json', '../registr-práv-a-povinností/údaje/2021-01-12/údaje.context.jsonld')"/>
