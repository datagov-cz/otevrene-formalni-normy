...
<html lang="cs">
  <head>
    <title>Registr práv a povinností - údaje</title>
    ...
    <script class="remove" src="údaje.config.js" />
  </head>
  <body>
    <xsl:apply-templates mode="abstrakt" />
    <xsl:sequence select="gen:generujDokumentaciPrvků('../registr-práv-a-povinností/údaje/2021-01-11/údaje.schema.json', '../registr-práv-a-povinností/údaje/2021-01-11/údaje.context.jsonld')"/>
