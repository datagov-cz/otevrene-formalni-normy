...
<html lang="cs">
  <head>
    <title>Registr práv a povinností - číselník typů subjektů</title>
    ...
    <script class="remove" src="číselník-typů-certifikací-informačních-systémů.config.js" />
  </head>
  <body>
    <xsl:apply-templates mode="abstrakt" />
    <xsl:sequence select="gen:generujDokumentaciPrvků('../registr-práv-a-povinností/číselník-typů-certifikací-informačních-systémů/draft/číselník-typů-certifikací-informačních-systémů.schema.json', '../registr-práv-a-povinností/číselník-typů-certifikací-informačních-systémů/draft/číselník-typů-certifikací-informačních-systémů.context.jsonld')"/>
