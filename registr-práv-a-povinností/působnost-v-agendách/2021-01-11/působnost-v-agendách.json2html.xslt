...
<html lang="cs">
  ...
  <body>
    ...
    <xsl:sequence select="gen:generujDokumentaciPrvků('../registr-práv-a-povinností/působnost-v-agendách/2021-01-11/působnost-v-agendách.schema.json', '../registr-práv-a-povinností/působnost-v-agendách/2021-01-11/působnost-v-agendách.context.jsonld')"/>
