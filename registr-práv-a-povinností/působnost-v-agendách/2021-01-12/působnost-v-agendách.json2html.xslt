...
<html lang="cs">
  <head>
    <title>Registr práv a povinností - působnost v agendách</title>
    ...
    <script class="remove" src="působnost-v-agendách.config.js" />
  </head>
  <body>
    <xsl:apply-templates mode="abstrakt" />
    <xsl:sequence select="gen:generujDokumentaciPrvků('../registr-práv-a-povinností/působnost-v-agendách/2021-01-12/působnost-v-agendách.schema.json', '../registr-práv-a-povinností/působnost-v-agendách/2021-01-12/působnost-v-agendách.context.jsonld')"/>
